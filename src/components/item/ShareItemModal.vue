...
const usersWithAccess = ref<
	{ id: number; name: string; initials: string; email: string; sharingId?: number }[]
>([]);
const search = ref('');
...
function getUserColorByInitials(initials: string) {
	const colours = [
		'#ef4444', // red-500
		'#f97316', // orange-500
		'#f59e0b', // amber-500
...
function getInitialsByName(name: string) {
